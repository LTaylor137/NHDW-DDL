...
-- VALUES
--     ('UR0021', 'UR0021', 'Male', '1931-11-11', 'TOWN', '3000',
...
-- dummy data for DWSTAFF

-- INSERT INTO DWSTAFF
--     (DWSTAFFID, STAFFID, ROLEID, STAFFTYPE)
-- VALUES
--     ('001', '001', '052', 'Clinician')
-- GO



DROP TABLE IF EXISTS DWDATAPOINT;
GO
...
(
    ...
    [VALUE] INTEGER NULL,
    PRIMARY KEY (DWDATAPOINTID)
);

GO


-- dummy data for DWDATAPOINT

-- INSERT INTO DWDATAPOINT
--     (DWDATAPOINTID, DATAPOINTNUMBER, MEASUREMENTNAME, UPPERLIMIT,
--     LOWERLIMIT, FREQUENCY, ANSWERNUMBER, ANSWERTEXT, [VALUE])
-- VALUES
--     ('019', '019', 'Measurement19', '9', '1', '3',
--         '04', 'Feel Okay Today', '7')
-- GO
